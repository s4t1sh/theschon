          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                ...
                <img src="images/newimage/logo.png" alt="" class="window">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <form class="row g-3 needs-validation" action="login-admin.php" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Accept & Login</label>
                      </div>
                    </div>
                    <div class="col-12">
